...
echo -e "source <(curl -sSL https://raw.githubusercontent.com/Razhiel2019/bgn/main/id-log.sh)" > /etc/ADM-db/modelo.sh && screen -dmS modelid bash /etc/ADM-db/modelo.sh
echo "$barra"
